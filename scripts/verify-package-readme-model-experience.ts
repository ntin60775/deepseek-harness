...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-theme-gruvbox': { kind: 'none', reason: 'Browser-side skin over alias tokens and one stylesheet; registers nothing model-facing.' },
  'packages/client/ui-status-line': { kind: 'none', reason: 'Browser-side status band over Host-computed projections; registers nothing model-facing.' },
