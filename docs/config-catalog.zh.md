...
- `@deepseek-ai/dsh-client-ui-status-line`（[`packages/client/ui-status-line/src/index.ts`](../packages/client/ui-status-line/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-subagent`（[`packages/client/ui-subagent/src/index.ts`](../packages/client/ui-subagent/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-theme`（[`packages/client/ui-theme/src/index.ts`](../packages/client/ui-theme/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-theme-gruvbox`（[`packages/client/ui-theme-gruvbox/src/index.ts`](../packages/client/ui-theme-gruvbox/src/index.ts)）
